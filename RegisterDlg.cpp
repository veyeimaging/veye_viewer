...
RegisterDlg::RegisterDlg(CommDevCfg devCfg, QWidget *parent)
    : QDialog(parent)
    , m_devCfg(devCfg)
...
void RegisterDlg::rcvUpdateUi()
{
    ...
    updateReg();
    QxHelp::setLabelElidedText(ui->labelAddr, Qt::ElideRight, 120, 0);
    QxHelp::setLabelElidedText(ui->labelValue, Qt::ElideRight, 120, 0);
}
